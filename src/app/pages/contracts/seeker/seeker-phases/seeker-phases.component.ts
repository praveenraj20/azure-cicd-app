...
import { ContractDetails, RequirementPhases } from 'src/app/api/flexcub-api/models';
import { AppService } from 'src/app/app.service';
import { ContractsService } from '../../contracts.service';

@Component({
  selector: 'app-seeker-phases',
  templateUrl: './seeker-phases.component.html',
  styleUrls: ['./seeker-phases.component.scss']
})
export class SeekerPhasesComponent implements OnInit {
  @Input() id!: number;
